...
class HomeController
{
    public function index()
    {
        ...
        $settings3 = [
            'chart_title'           => 'New Doctors Last Two Weeks',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Doctor',
            'group_by_field'        => 'created_at',
        ...
        $settings4 = [
            'chart_title'           => 'New Providers Last Two Weeks',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings5 = [
            'chart_title'           => 'Monthly Rate Of New Incoming Doctors',
            'chart_type'            => 'line',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Doctor',
            'group_by_field'        => 'created_at',
        ...
        $settings6 = [
            'chart_title'           => 'Monthly Rate Of New Incoming Providers',
            'chart_type'            => 'line',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Provider',
            'group_by_field'        => 'created_at',
