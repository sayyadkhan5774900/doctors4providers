    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.providers.update", [$provider->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $provider->first_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $provider->last_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $provider->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $provider->phone) }}" required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_agreement') ? 'is-invalid' : '' }}" type="text" name="date_of_agreement" id="date_of_agreement" value="{{ old('date_of_agreement', $provider->date_of_agreement) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('practice') ? 'is-invalid' : '' }}" name="practice" id="practice">{{ old('practice', $provider->practice) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('current_licensure') ? 'is-invalid' : '' }}" name="current_licensure" id="current_licensure">{{ old('current_licensure', $provider->current_licensure) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('collaborative_need') ? 'is-invalid' : '' }}" name="collaborative_need" id="collaborative_need" required>{{ old('collaborative_need', $provider->collaborative_need) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('practice_states') ? 'is-invalid' : '' }}" type="text" name="practice_states" id="practice_states" value="{{ old('practice_states', $provider->practice_states) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('communication_form') ? 'is-invalid' : '' }}" name="communication_form" id="communication_form" required>{{ old('communication_form', $provider->communication_form) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('collaborative_communication') ? 'is-invalid' : '' }}" name="collaborative_communication" id="collaborative_communication" required>{{ old('collaborative_communication', $provider->collaborative_communication) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('emr_system') ? 'is-invalid' : '' }}" name="emr_system" id="emr_system">{{ old('emr_system', $provider->emr_system) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('meeting_time') ? 'is-invalid' : '' }}" name="meeting_time" id="meeting_time">{{ old('meeting_time', $provider->meeting_time) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('begin_seeing_patients') ? 'is-invalid' : '' }}" type="text" name="begin_seeing_patients" id="begin_seeing_patients" value="{{ old('begin_seeing_patients', $provider->begin_seeing_patients) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('have_malpractice') ? 'is-invalid' : '' }}" type="text" name="have_malpractice" id="have_malpractice" value="{{ old('have_malpractice', $provider->have_malpractice) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('agent_can_contact') ? 'is-invalid' : '' }}" name="agent_can_contact" id="agent_can_contact">
                    ...
                    @foreach(App\Models\Provider::AGENT_CAN_CONTACT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('agent_can_contact', $provider->agent_can_contact) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('have_billing_company') ? 'is-invalid' : '' }}" name="have_billing_company" id="have_billing_company" required>
                    ...
                    @foreach(App\Models\Provider::HAVE_BILLING_COMPANY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('have_billing_company', $provider->have_billing_company) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('billing_company_can_contact') ? 'is-invalid' : '' }}" name="billing_company_can_contact" id="billing_company_can_contact">
                    ...
                    @foreach(App\Models\Provider::BILLING_COMPANY_CAN_CONTACT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('billing_company_can_contact', $provider->billing_company_can_contact) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_budget') ? 'is-invalid' : '' }}" type="number" name="monthly_budget" id="monthly_budget" value="{{ old('monthly_budget', $provider->monthly_budget) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('additional_notes') ? 'is-invalid' : '' }}" name="additional_notes" id="additional_notes">{{ old('additional_notes', $provider->additional_notes) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percentage_of_chart') ? 'is-invalid' : '' }}" type="number" name="percentage_of_chart" id="percentage_of_chart" value="{{ old('percentage_of_chart', $provider->percentage_of_chart) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('need_prescriptive_authority') ? 'is-invalid' : '' }}" type="text" name="need_prescriptive_authority" id="need_prescriptive_authority" value="{{ old('need_prescriptive_authority', $provider->need_prescriptive_authority) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('prescribing_substances') ? 'is-invalid' : '' }}" name="prescribing_substances" id="prescribing_substances" required>{{ old('prescribing_substances', $provider->prescribing_substances) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('provider_need_collaborative_speak') ? 'is-invalid' : '' }}" type="text" name="provider_need_collaborative_speak" id="provider_need_collaborative_speak" value="{{ old('provider_need_collaborative_speak', $provider->provider_need_collaborative_speak) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('unique_request') ? 'is-invalid' : '' }}" name="unique_request" id="unique_request">{{ old('unique_request', $provider->unique_request) }}</textarea>
