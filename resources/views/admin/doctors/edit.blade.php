    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.doctors.update", [$doctor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('monthly_stipend') ? 'is-invalid' : '' }}" name="monthly_stipend" id="monthly_stipend" required>{{ old('monthly_stipend', $doctor->monthly_stipend) }}</textarea>
