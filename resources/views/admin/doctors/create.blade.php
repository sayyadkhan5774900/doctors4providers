    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.doctors.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('practice') ? 'is-invalid' : '' }}" name="practice" id="practice" required>{{ old('practice') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('specialization') ? 'is-invalid' : '' }}" name="specialization" id="specialization" required>{{ old('specialization') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('certifications') ? 'is-invalid' : '' }}" name="certifications" id="certifications">{{ old('certifications') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('states_licensed') ? 'is-invalid' : '' }}" name="states_licensed" id="states_licensed" required>{{ old('states_licensed') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('have_malpractice') ? 'is-invalid' : '' }}" name="have_malpractice" id="have_malpractice" required>{{ old('have_malpractice') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_stipend') ? 'is-invalid' : '' }}" type="number" name="monthly_stipend" id="monthly_stipend" value="{{ old('monthly_stipend', '') }}" step="0.01" required>
